      ...
      <div className="mx-auto max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="rounded-lg bg-white p-6 shadow-sm">
            ...
            <div className="mb-6 grid grid-cols-1 gap-6 md:grid-cols-2">
              <div><label className="block text-sm font-medium text-gray-700 mb-2">관리자 이메일</label><input type="email" name="adminEmail" value={cloud.adminEmail} onChange={onCloudChange} className={inputCls} /></div>
            </div>
