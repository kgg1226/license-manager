...
interface Asset {
  ...
  expiryDate?: string | null; assignee?: { id: number; name: string } | null;
          ...
          <table className="w-full">
            <thead className="border-b bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-semibold">장비 유형</th>
                <th className="px-6 py-3 text-left text-xs font-semibold">제조사 / 모델</th>
